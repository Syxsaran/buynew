...
namespace buynew
{
    public partial class S3 : Form
    {
        ...
        private void openToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (openFileDialog.ShowDialog() == DialogResult.OK)
            {
                ...
                for (int i = 0; i < readAllLine.Length; i++)
                {
                    ...
                    ClassS3 classS3 = new ClassS3(classs3Splited[0], classs3Splited[1], classs3Splited[2], classs3Splited[3]);
                    addDataToGridView(classs3Splited[0], classs3Splited[1], classs3Splited[2], classs3Splited[3]);
                }
            }
        }
        ...
        {
            MessageBox.Show("คุณได้สั่งซื้อบัตรของ ศิลปินคนที่3 เเล้ว");
